...
const CHANNELS: Channel[] = [
  ...
  },
  {
    ...
    body: "Track open work, file ideas, and talk through the rough edges with the team. The orchestrator, sandbox agent, and SDK live in the open.",
  ...
  },
  {
    ...
    iconClass: "cyan",
    title: "X / Twitter",
    body: "Ship-logs, demos, and quick tips on getting the most out of Auto routing and the three model providers. Tag us in what you make.",
